...
public class biaya_suite2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        harga.setText("Total Biaya yang harus anda bayarkan sebesar : Rp. "+lanjutan_suite2.a);
        ...
        proses_diskon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(diskon.getText().toString().trim().length() <=0){
                    Toast.makeText(biaya_suite2.this,"Kode diskon kosong", Toast.LENGTH_LONG).show();
                }
                    ...
                    Toast.makeText(biaya_suite2.this,"Kode diskon salah", Toast.LENGTH_LONG).show();
                }
            }
        });
