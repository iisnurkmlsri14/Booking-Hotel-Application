...
public class verifikasi_suite3 extends AppCompatActivity {
    public static int a;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i =new Intent (getApplicationContext(),biaya_suite3.class);
                startActivity(i);
            }
        });
        ...
        tidak.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i =new Intent (getApplicationContext(),kamar_suite3.class);
                startActivity(i);
            }
        });
    }
