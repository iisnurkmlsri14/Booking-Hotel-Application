...
public class kamar_suite2 extends AppCompatActivity {
    public static int harganya = 750000;
        ...
        next.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(nama.getText().toString().trim().length() <=0 || hp.getText().toString().trim().length() <=0 || alamat.getText().toString().trim().length() <=0 ){
                    Toast.makeText(kamar_suite2.this,"Data Harus Dilengkapi", Toast.LENGTH_LONG).show();
                }else{
                    ...
                    Intent i =new Intent (getApplicationContext(),lanjutan_suite2.class);
                    startActivity(i);
                }
