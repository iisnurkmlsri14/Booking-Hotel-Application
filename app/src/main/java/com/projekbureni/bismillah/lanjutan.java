        ...
        kalku.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(lama.getText().toString().trim().length() <=0){
                    Toast.makeText(lanjutan.this,"Data Harus Dilengkapi", Toast.LENGTH_LONG).show();
                }else if(!dewe.isChecked() && !dobel.isChecked()){
                    Toast.makeText(lanjutan.this,"Anda belum memilih Tipe Kamar", Toast.LENGTH_LONG).show();
                }
                else if(dewe.isChecked()){
                    kamare = dewe.getText().toString();
                    value= lama.getText().toString();
                    int lama_inap = Integer.parseInt(value);
                    a=(kamar_standard.harganya+100000)*lama_inap;
                    Intent i =new Intent (getApplicationContext(),verifikasi.class);
                    startActivity(i);
                }
                    ...
                    value= lama.getText().toString();
                    int lama_inap = Integer.parseInt(value);
                    a=(kamar_standard.harganya+200000)*lama_inap;
                    Intent i =new Intent (getApplicationContext(),verifikasi.class);
                    startActivity(i);
                }
                }
