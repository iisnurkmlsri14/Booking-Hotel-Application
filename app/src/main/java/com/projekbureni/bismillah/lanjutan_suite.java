...
public class lanjutan_suite extends AppCompatActivity {
    public static int a;
        ...
        kalku.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(lama.getText().toString().trim().length() <=0){
                    Toast.makeText(lanjutan_suite.this,"Data Harus Dilengkapi", Toast.LENGTH_LONG).show();
                }else if(!dewe.isChecked() && !dobel.isChecked()){
                    Toast.makeText(lanjutan_suite.this,"Anda belum memilih Tipe Kamar", Toast.LENGTH_LONG).show();
                }
                    ...
                    Intent i =new Intent (getApplicationContext(),verifikasi_suite.class);
                    startActivity(i);
                }
