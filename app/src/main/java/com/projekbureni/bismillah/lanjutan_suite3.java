...
public class lanjutan_suite3 extends AppCompatActivity {
    public static int a;
        ...
        kalku.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(lama.getText().toString().trim().length() <=0){
                    Toast.makeText(lanjutan_suite3.this,"Data Harus Dilengkapi", Toast.LENGTH_LONG).show();
                }else if(!dewe.isChecked() && !dobel.isChecked()){
                    Toast.makeText(lanjutan_suite3.this,"Anda belum memilih Tipe Kamar", Toast.LENGTH_LONG).show();
                }
                else if(dewe.isChecked()){
                    kamare = dewe.getText().toString();
                    value= lama.getText().toString();
                    int lama_inap = Integer.parseInt(value);
                    a=(kamar_suite.harganya+100000)*lama_inap;
                    Intent i =new Intent (getApplicationContext(),verifikasi_suite3.class);
                    startActivity(i);
                }
                    ...
                    value= lama.getText().toString();
                    int lama_inap = Integer.parseInt(value);
                    a=(kamar_suite.harganya+200000)*lama_inap;
                    Intent i =new Intent (getApplicationContext(),verifikasi_suite3.class);
                    startActivity(i);
                }
            }
